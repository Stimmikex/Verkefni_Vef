...
<body>
	<?php
		...
		?>
		<h1 class="page_title">Request ride!</h1>
		    ...
		    <div class="row">
				...
				<?php
					if (isset($_POST['submit'])) {
						...
						$insert_request = "INSERT INTO asking (to_id, from_id, message, timewhen, datetogo, user_id) VALUES (:to_id, :from_id, :message, :timeride, :dateride, :user_id)";
